...
public class Spine_Unity_SkeletonDataAssetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("skeletonDataModifiers", get_skeletonDataModifiers, set_skeletonDataModifiers);
	...
	static int CreateRuntimeInstance(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<Spine.Unity.AtlasAssetBase, bool>(L, 2))
			{
				UnityEngine.TextAsset arg0 = (UnityEngine.TextAsset)ToLua.CheckObject<UnityEngine.TextAsset>(L, 1);
				Spine.Unity.AtlasAssetBase arg1 = (Spine.Unity.AtlasAssetBase)ToLua.ToObject(L, 2);
				bool arg2 = LuaDLL.lua_toboolean(L, 3);
				Spine.Unity.SkeletonDataAsset o = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance(arg0, arg1, arg2);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes<Spine.Unity.AtlasAssetBase[], bool>(L, 2))
			{
				UnityEngine.TextAsset arg0 = (UnityEngine.TextAsset)ToLua.CheckObject<UnityEngine.TextAsset>(L, 1);
				Spine.Unity.AtlasAssetBase[] arg1 = ToLua.ToObjectArray<Spine.Unity.AtlasAssetBase>(L, 2);
				bool arg2 = LuaDLL.lua_toboolean(L, 3);
				Spine.Unity.SkeletonDataAsset o = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance(arg0, arg1, arg2);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<Spine.Unity.AtlasAssetBase, bool, float>(L, 2))
			{
				UnityEngine.TextAsset arg0 = (UnityEngine.TextAsset)ToLua.CheckObject<UnityEngine.TextAsset>(L, 1);
				Spine.Unity.AtlasAssetBase arg1 = (Spine.Unity.AtlasAssetBase)ToLua.ToObject(L, 2);
				bool arg2 = LuaDLL.lua_toboolean(L, 3);
	...
	static int get_atlasAssets(IntPtr L)
	{
		...
		try
		{
			...
			Spine.Unity.AtlasAssetBase[] ret = obj.atlasAssets;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_skeletonDataModifiers(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Spine.Unity.SkeletonDataAsset obj = (Spine.Unity.SkeletonDataAsset)o;
			System.Collections.Generic.List<Spine.Unity.SkeletonDataModifierAsset> ret = obj.skeletonDataModifiers;
			ToLua.PushSealed(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index skeletonDataModifiers on a nil value");
		}
	}
	...
	static int set_atlasAssets(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Spine.Unity.SkeletonDataAsset obj = (Spine.Unity.SkeletonDataAsset)o;
			Spine.Unity.AtlasAssetBase[] arg0 = ToLua.CheckObjectArray<Spine.Unity.AtlasAssetBase>(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_skeletonDataModifiers(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Spine.Unity.SkeletonDataAsset obj = (Spine.Unity.SkeletonDataAsset)o;
			System.Collections.Generic.List<Spine.Unity.SkeletonDataModifierAsset> arg0 = (System.Collections.Generic.List<Spine.Unity.SkeletonDataModifierAsset>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<Spine.Unity.SkeletonDataModifierAsset>));
			obj.skeletonDataModifiers = arg0;
			return 0;
		}
		catch(Exception e)
		{
