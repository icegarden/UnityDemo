...
public class Spine_ShearTimelineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Spine.ShearTimeline), typeof(Spine.TranslateTimeline));
		L.RegFunction("Apply", Apply);
		L.RegFunction("New", _CreateSpine_ShearTimeline);
	...
	static int _CreateSpine_ShearTimeline(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				Spine.ShearTimeline obj = new Spine.ShearTimeline(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Spine.ShearTimeline.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Apply(IntPtr L)
	{
		try
		{
			...
			Spine.ShearTimeline obj = (Spine.ShearTimeline)ToLua.CheckObject<Spine.ShearTimeline>(L, 1);
	...
	static int get_PropertyId(IntPtr L)
	{
		...
		try
		{
			...
			Spine.ShearTimeline obj = (Spine.ShearTimeline)o;
