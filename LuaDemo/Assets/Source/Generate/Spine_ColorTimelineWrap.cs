...
public class Spine_ColorTimelineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Spine.ColorTimeline), typeof(Spine.CurveTimeline));
		L.RegFunction("SetFrame", SetFrame);
		L.RegFunction("Apply", Apply);
		L.RegFunction("New", _CreateSpine_ColorTimeline);
	...
	static int _CreateSpine_ColorTimeline(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				Spine.ColorTimeline obj = new Spine.ColorTimeline(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Spine.ColorTimeline.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SetFrame(IntPtr L)
	{
		try
		{
			...
			Spine.ColorTimeline obj = (Spine.ColorTimeline)ToLua.CheckObject<Spine.ColorTimeline>(L, 1);
	...
	static int get_PropertyId(IntPtr L)
	{
		...
		try
		{
			...
			Spine.ColorTimeline obj = (Spine.ColorTimeline)o;
