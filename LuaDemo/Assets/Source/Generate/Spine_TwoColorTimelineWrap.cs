...
public class Spine_TwoColorTimelineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Spine.TwoColorTimeline), typeof(Spine.CurveTimeline));
		L.RegFunction("SetFrame", SetFrame);
		L.RegFunction("Apply", Apply);
		L.RegFunction("New", _CreateSpine_TwoColorTimeline);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegConstant("ENTRIES", 8);
	...
	static int _CreateSpine_TwoColorTimeline(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				Spine.TwoColorTimeline obj = new Spine.TwoColorTimeline(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Spine.TwoColorTimeline.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SetFrame(IntPtr L)
	{
		try
		{
			...
			Spine.TwoColorTimeline obj = (Spine.TwoColorTimeline)ToLua.CheckObject<Spine.TwoColorTimeline>(L, 1);
	...
	static int get_PropertyId(IntPtr L)
	{
		...
		try
		{
			...
			Spine.TwoColorTimeline obj = (Spine.TwoColorTimeline)o;
