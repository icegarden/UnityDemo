...
public class Spine_TranslateTimelineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Spine.TranslateTimeline), typeof(Spine.CurveTimeline));
		L.RegFunction("SetFrame", SetFrame);
		L.RegFunction("Apply", Apply);
		L.RegFunction("New", _CreateSpine_TranslateTimeline);
	...
	static int _CreateSpine_TranslateTimeline(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				Spine.TranslateTimeline obj = new Spine.TranslateTimeline(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Spine.TranslateTimeline.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SetFrame(IntPtr L)
	{
		try
		{
			...
			Spine.TranslateTimeline obj = (Spine.TranslateTimeline)ToLua.CheckObject<Spine.TranslateTimeline>(L, 1);
	...
	static int get_PropertyId(IntPtr L)
	{
		...
		try
		{
			...
			Spine.TranslateTimeline obj = (Spine.TranslateTimeline)o;
