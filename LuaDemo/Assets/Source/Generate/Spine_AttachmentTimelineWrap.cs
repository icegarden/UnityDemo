...
public class Spine_AttachmentTimelineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Spine.AttachmentTimeline), typeof(System.Object));
		L.RegFunction("SetFrame", SetFrame);
		L.RegFunction("Apply", Apply);
		L.RegFunction("New", _CreateSpine_AttachmentTimeline);
		...
		L.RegVar("AttachmentNames", get_AttachmentNames, set_AttachmentNames);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateSpine_AttachmentTimeline(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				Spine.AttachmentTimeline obj = new Spine.AttachmentTimeline(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Spine.AttachmentTimeline.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SetFrame(IntPtr L)
	{
		try
		{
			...
			Spine.AttachmentTimeline obj = (Spine.AttachmentTimeline)ToLua.CheckObject<Spine.AttachmentTimeline>(L, 1);
	...
	static int get_PropertyId(IntPtr L)
	{
		...
		try
		{
			...
			Spine.AttachmentTimeline obj = (Spine.AttachmentTimeline)o;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_AttachmentNames(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Spine.AttachmentTimeline obj = (Spine.AttachmentTimeline)o;
			string[] ret = obj.AttachmentNames;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index AttachmentNames on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_AttachmentNames(IntPtr L)
	{
		object o = null;
