        ...
        private sealed partial class ResourceLoader
        {
            ...
            private sealed partial class LoadResourceAgent : ITaskAgent<LoadResourceTaskBase>
            {
                ...
                private void OnAssetObjectReady(AssetObject assetObject)
                {
                    ...
                    var _resourceObject = m_ResourceLoader.m_ResourcePool.Spawn(resourceName);
                    if (_resourceObject != null)
                    {
                        Helper.OnBundleReady(_resourceObject.Target);
                    }
                ...
                {
                    Helper.OnBundleReady(resourceObject.Target);
