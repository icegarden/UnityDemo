...
namespace Tree
{
    public partial class UI_TreePetListSkin : GComponent
    {
        ...
        public GGroup m_n13;
        public const string URL = "ui://jj5xd8f5mde4w";

        public static UI_TreePetListSkin CreateInstance()
        {
            return (UI_TreePetListSkin)UIPackage.CreateComponet("Tree", "TreePetListSkin");
        }
