...
namespace World
{
    public partial class UI_WorldPVPChallengeSkin : GComponent
    {
        public GLabel m_bg;
        ...
        public const string URL = "ui://63ubk2jojpuu3x";

        public static UI_WorldPVPChallengeSkin CreateInstance()
        {
            return (UI_WorldPVPChallengeSkin)UIPackage.CreateComponet("World", "WorldPVPChallengeSkin");
        }
