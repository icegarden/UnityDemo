...
namespace World
{
    public partial class UI_WorldShopItemSkin : GComponent
    {
        public GImage m_n7;
        public GImage m_n9;
        ...
        public const string URL = "ui://63ubk2jodibin";

        public static UI_WorldShopItemSkin CreateInstance()
        {
            return (UI_WorldShopItemSkin)UIPackage.CreateComponet("World", "WorldShopItemSkin");
        }
