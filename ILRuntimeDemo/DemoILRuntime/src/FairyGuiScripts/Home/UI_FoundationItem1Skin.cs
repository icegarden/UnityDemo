...
namespace Home
{
    public partial class UI_FoundationItem1Skin : GComponent
    {
        ...
        public const string URL = "ui://wua6gzxlikzm15";

        public static UI_FoundationItem1Skin CreateInstance()
        {
            return (UI_FoundationItem1Skin)UIPackage.CreateComponet("Home", "FoundationItem1Skin");
        }
