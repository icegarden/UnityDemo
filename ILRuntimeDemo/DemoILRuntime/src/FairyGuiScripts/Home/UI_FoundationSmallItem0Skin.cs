...
namespace Home
{
    public partial class UI_FoundationSmallItem0Skin : GComponent
    {
        ...
        public const string URL = "ui://wua6gzxlikzm1v";

        public static UI_FoundationSmallItem0Skin CreateInstance()
        {
            return (UI_FoundationSmallItem0Skin)UIPackage.CreateComponet("Home", "FoundationSmallItem0Skin");
        }
