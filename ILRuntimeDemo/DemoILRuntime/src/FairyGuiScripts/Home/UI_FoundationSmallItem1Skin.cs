...
namespace Home
{
    public partial class UI_FoundationSmallItem1Skin : GComponent
    {
        ...
        public const string URL = "ui://wua6gzxlikzm1w";

        public static UI_FoundationSmallItem1Skin CreateInstance()
        {
            return (UI_FoundationSmallItem1Skin)UIPackage.CreateComponet("Home", "FoundationSmallItem1Skin");
        }
