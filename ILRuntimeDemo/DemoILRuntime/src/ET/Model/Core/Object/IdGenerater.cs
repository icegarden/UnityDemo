...
namespace ET
{
    ...
    public class IdGenerater: IDisposable
    {
        ...
        {
            uint a = (uint)((GameRoot.TimeInfo.FrameTime - this.epoch2020) / 1000);
            return a;
        }
        
        private uint TimeSinceThisYear()
        {
            uint a = (uint)((GameRoot.TimeInfo.FrameTime - this.epochThisYear) / 1000);
            return a;
        }
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(this.lastInstanceIdTime, GameRoot.Options.Process, this.instanceIdValue);
        ...
        public long GenerateId()
        {
            ...
            IdStruct idStruct = new IdStruct(this.lastIdTime, GameRoot.Options.Process, value);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, GameRoot.Options.Process, this.lastUnitIdTime, this.unitIdValue);
