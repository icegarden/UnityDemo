    ...
    public partial class Entity: DisposeObject
    {
        ...
        public Dictionary<long, Entity> Children
        {
            get
            {
                if (this.children == null)
                {
                    this.children = ObjectPool.Get<Dictionary<long, Entity>>();
                }
        ...
        private void AddToChildrenDB(Entity entity)
        {
            ...
            this.childrenDB = this.childrenDB ?? ObjectPool.Get<HashSet<Entity>>();
        ...
        public Dictionary<Type, Entity> Components
        {
            get
            {
                if (this.components == null)
                {
                    this.components = ObjectPool.Get<Dictionary<Type, Entity>>();
                }
        ...
        private void AddToComponentsDB(Entity component)
        {
            ...
            if (this.componentsDB == null)
            {
                this.componentsDB = ObjectPool.Get<HashSet<Entity>>();
            }
        ...
        private static Entity Create(Type type, bool isFromPool)
        {
            ...
            if (isFromPool)
            {
                component = (Entity)ObjectPool.Get(type);
            }
            else
            {
