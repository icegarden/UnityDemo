...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_IO_Path_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetFileNameWithoutExtension_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetExtension", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetExtension_2);
        ...
        static StackObject* GetFileNameWithoutExtension_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetExtension_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
