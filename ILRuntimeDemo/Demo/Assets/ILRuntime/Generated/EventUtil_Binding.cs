...
{
    unsafe class EventUtil_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::EventUtil);
            args = new Type[]{typeof(System.String), typeof(FairyGUI.EventCallback1), typeof(System.Boolean)};
            ...
            app.RegisterCLRMethodRedirection(method, off_1);
            args = new Type[]{typeof(System.String), typeof(System.Object[])};
            method = type.GetMethod("dispatch", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, dispatch_2);
        ...
        static StackObject* on_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Boolean @isOnce = ptr_of_this_method->Value == 1;
            ...
            global::EventUtil.on(@type, @callback, @isOnce);

            return __ret;
        }

        static StackObject* off_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            global::EventUtil.off(@type, @callback);

            return __ret;
        }

        static StackObject* dispatch_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            global::EventUtil.dispatch(@type, @data);
