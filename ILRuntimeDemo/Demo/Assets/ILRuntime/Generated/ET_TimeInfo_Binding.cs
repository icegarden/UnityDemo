...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_TimeInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_FrameTime_0);
            app.RegisterCLRFieldSetter(field, set_FrameTime_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_FrameTime_0, AssignFromStack_FrameTime_0);
        ...
        static object get_FrameTime_0(ref object o)
        {
            return ((ET.TimeInfo)o).FrameTime;
        }

        static StackObject* CopyToStack_FrameTime_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_FrameTime_0(ref object o, object v)
        {
            ((ET.TimeInfo)o).FrameTime = (System.Int64)v;
        }

        static StackObject* AssignFromStack_FrameTime_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
