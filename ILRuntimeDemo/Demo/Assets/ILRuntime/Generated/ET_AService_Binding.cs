...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_AService_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Int64), typeof(System.Int16), typeof(System.IO.MemoryStream)};
            method = type.GetMethod("SendStream", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SendStream_1);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, IsDispose_4);
            ...
            field = type.GetField("ConnectCallBack", flag);
            app.RegisterCLRFieldGetter(field, get_ConnectCallBack_2);
            app.RegisterCLRFieldSetter(field, set_ConnectCallBack_2);
            app.RegisterCLRFieldBinding(field, CopyToStack_ConnectCallBack_2, AssignFromStack_ConnectCallBack_2);
            field = type.GetField("DisconnectCallBack", flag);
            app.RegisterCLRFieldGetter(field, get_DisconnectCallBack_3);
            app.RegisterCLRFieldSetter(field, set_DisconnectCallBack_3);
            app.RegisterCLRFieldBinding(field, CopyToStack_DisconnectCallBack_3, AssignFromStack_DisconnectCallBack_3);
        ...
        static StackObject* SendStream_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Int16 @cmd = (short)ptr_of_this_method->Value;
            ...
            instance_of_this_method.SendStream(@channelId, @cmd, @stream);
        ...
        static StackObject* IsDispose_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static object get_ConnectCallBack_2(ref object o)
        {
            return ((ET.AService)o).ConnectCallBack;
        }

        static StackObject* CopyToStack_ConnectCallBack_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ET.AService)o).ConnectCallBack;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_ConnectCallBack_2(ref object o, object v)
        {
            ((ET.AService)o).ConnectCallBack = (System.Action<System.Int64>)v;
        }

        static StackObject* AssignFromStack_ConnectCallBack_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            System.Action<System.Int64> @ConnectCallBack = (System.Action<System.Int64>)typeof(System.Action<System.Int64>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            ((ET.AService)o).ConnectCallBack = @ConnectCallBack;
            return ptr_of_this_method;
        }

        static object get_DisconnectCallBack_3(ref object o)
        {
            return ((ET.AService)o).DisconnectCallBack;
        }

        static StackObject* CopyToStack_DisconnectCallBack_3(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ET.AService)o).DisconnectCallBack;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_DisconnectCallBack_3(ref object o, object v)
        {
            ((ET.AService)o).DisconnectCallBack = (System.Action<System.Int64>)v;
        }

        static StackObject* AssignFromStack_DisconnectCallBack_3(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            System.Action<System.Int64> @DisconnectCallBack = (System.Action<System.Int64>)typeof(System.Action<System.Int64>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            ((ET.AService)o).DisconnectCallBack = @DisconnectCallBack;
            return ptr_of_this_method;
        }
