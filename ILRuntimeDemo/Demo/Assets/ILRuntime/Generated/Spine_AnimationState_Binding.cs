...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Spine_AnimationState_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, remove_Complete_1);
            args = new Type[]{typeof(Spine.AnimationState.TrackEntryDelegate)};
            method = type.GetMethod("add_Complete", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, add_Complete_2);
        ...
        static StackObject* remove_Complete_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* add_Complete_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
