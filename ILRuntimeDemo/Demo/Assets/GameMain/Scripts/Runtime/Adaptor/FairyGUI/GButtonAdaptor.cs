...
public class GButtonAdaptor : CrossBindingAdaptor
{
 ...
 static CrossBindingMethodInfo<XML> _ConstructFromXML = new CrossBindingMethodInfo<XML>("ConstructFromXML");
    static CrossBindingMethodInfo<Controller> _HandleControllerChanged = new CrossBindingMethodInfo<Controller>("HandleControllerChanged");
    // static CrossBindingFunctionInfo<GTextField> _GetTextField = new CrossBindingFunctionInfo<GTextField>("GetTextField");
    ...
    class Adaptor : GButton, CrossBindingAdaptorType
    {
        ...
        {
            if (_HandleControllerChanged.CheckShouldInvokeBase(this.instance))
                base.HandleControllerChanged(c);
            else
                _HandleControllerChanged.Invoke(this.instance, c);
        }
