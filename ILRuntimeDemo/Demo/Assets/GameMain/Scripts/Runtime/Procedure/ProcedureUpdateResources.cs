...
public class ProcedureUpdateResources : ProcedureBase2
{
    ...
    protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
    {
        ...
        Game.Event.Subscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
        Game.Event.Subscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
        Game.Event.Subscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
        Game.Event.Subscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
        ...
        if (Application.internetReachability == NetworkReachability.ReachableViaCarrierDataNetwork)
        {
            ...
            // {
            //     Mode = 2,
            //     Title = Game.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Title"),
            //     Message = Game.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Message"),
            //     ConfirmText = Game.Localization.GetString("UpdateResourceViaCarrierDataNetwork.UpdateButton"),
            //     OnClickConfirm = StartUpdateResources,
            //     CancelText = Game.Localization.GetString("UpdateResourceViaCarrierDataNetwork.QuitButton"),
    ...
    {
        Game.Event.Unsubscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
        Game.Event.Unsubscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
        Game.Event.Unsubscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
        Game.Event.Unsubscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
    ...
    private void StartUpdateResources(object userData)
    {
        ...
        Game.Resource.UpdateResources(OnUpdateResourcesComplete);
    }
    ...
    private void RefreshProgress()
    {
        ...
        string descriptionText = Game.Localization.GetString("UpdateResource.Tips", m_UpdateCount.ToString(), m_UpdateCount.ToString(), GetByteLengthString(currentTotalUpdateLength), GetByteLengthString(m_UpdateTotalCompressedLength), progressTotal, GetByteLengthString((int)Game.Download.CurrentSpeed));
        // Log.Info(descriptionText);
        Game.m_UpdateResourceForm.SetProgress(progressTotal, descriptionText);
    }
