...
namespace FairyGUI
{
    ...
    public class UIPackage
    {
        ...
        public static GComponent CreateComponet(string pkgName, string resName)
        {
            return (GComponent)CreateObject(pkgName, resName);
        }

        public static GComponent CreateComponet(string pkgName, string resName, System.Type userClass)
        {
            return (GComponent)CreateObject(pkgName, resName, userClass);
        }
        /// <summary>
        /// Create a UI object.
        /// </summary>
